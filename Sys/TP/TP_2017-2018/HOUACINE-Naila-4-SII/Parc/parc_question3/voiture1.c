...
//creation d'une clé
key_t key = ftok("/home/izan/Desktop/Naila/Sys",'g');
...
P(semid, semTousAbord); //ici le processus voiture se bloque et attend d’être libéré par le dernier client qui monte, pour ensuite rouler ….
...
P(semid, semTousDehors); //le processus voiture se bloque ici et attend que le dernier client qui descent le reveil
}
