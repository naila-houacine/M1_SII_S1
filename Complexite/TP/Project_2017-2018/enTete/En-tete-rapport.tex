...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	{\huge\bfseries Rapport du Mini Projet N\textdegree  \reportnumber \\ \reporttitle}\\[0.4cm] % Title of your document
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushleft}
			\large
			\textit{Quadrinôme}\\
			MEDJEKOUNE  \textsc{Sofiane} % Your name
			\\
			HADJERES  \textsc{Yasmine} % Your name
			\\
